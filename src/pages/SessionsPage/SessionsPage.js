...
export default function SessionsPage() {
    ...
    useEffect(() => {
        const urlSession = `https://mock-api.driven.com.br/api/v8/cineflex/movies/${idFilme}/showtimes`
    ...
    return (
        <PageContainer>
            ...
            <FooterContainer>
                <div>
                    <img src={movieSession.posterURL} alt="poster" />
                </div>
                <div>
